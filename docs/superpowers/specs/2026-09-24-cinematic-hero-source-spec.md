# Source spec · "Mostar city" cinematic scroll page

Saved verbatim on 2026-09-24 from the prompt Qie supplied. This is the authority for every
numeric value the cinematic hero reuses. The adaptations for The Upgrade are listed in
`2026-09-24-cinematic-hero-design.md`. Do not edit this file; edit the design spec.

The remote assets and font below are NOT used by The Upgrade (see the design spec, §7 and §9).
